...
export class CountryService {
  ...
  getAllAsync(): Observable<CountryGridModel[]> {
    ...
    let getCountries: Observable<CountryGridModel[]> =
      this.httpClient.get<CountryGridModel[]>(getAllAsyncUrl);
  ...
  getByIdAsync(id: number): Observable<CountryViewModel> {
    ...
    let getCountry: Observable<CountryViewModel> =
      this.httpClient.get<CountryViewModel>(getByIdAsyncUrl);
  ...
  createAsync(createModel: CountryCreateModel): Observable<CountryCreateModel> {
    ...
    let createCountry: Observable<CountryCreateModel> =
      this.httpClient.post<CountryCreateModel>(createAsyncUrl, createModel);
  ...
  updateAsync(updateModel: CountryUpdateModel): Observable<CountryUpdateModel> {
    ...
    let updateCountry: Observable<CountryUpdateModel> =
      this.httpClient.put<CountryUpdateModel>(updateAsyncUrl, updateModel);
  ...
  deleteAsync(id: number): Observable<boolean> {
    ...
    let deleteCountry: Observable<boolean> =
